<form class="form-inline" method="get" action="{{ route('list.files') }}">
    <div class="input-group input-group-sm">
        ...
        <input type="text" id="" name="query" class="form-control bg-light-success border-0 px-4 p-0 rounded-start-0 rounded-end-5 text-dark fs-4" placeholder="Search" aria-label="Search" aria-describedby="searchIcon" >
    </div>
  </form>